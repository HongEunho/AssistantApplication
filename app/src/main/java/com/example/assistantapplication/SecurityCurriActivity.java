...
public class SecurityCurriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_curri);

        final Activity a = SecurityCurriActivity.this;
        ...
        new JSONTask().execute(ser+"/curriculum/정보보호학과");
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new JSONTask2().execute(ser+"/curriculum/정보보호학과");
