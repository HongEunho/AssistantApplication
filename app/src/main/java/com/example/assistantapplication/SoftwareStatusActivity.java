...
public class SoftwareStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_software_status);
        ...
        new JSONTask().execute(ser+"/status/소프트웨어학과");
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new JSONTask2().execute("http://mfam.site:3001status/소프트웨어학과");
