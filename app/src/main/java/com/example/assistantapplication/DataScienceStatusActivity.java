...
public class DataScienceStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_science_status);

        final Activity a = DataScienceStatusActivity.this;
        ...
        new JSONTask().execute(ser+"/status/데이터사이언스학과");

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new JSONTask2().execute(ser+"/status/데이터사이언스학과");
