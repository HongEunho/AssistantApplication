...
public class IntellStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intell_status);
        setTitle("지능기전공학부 조교관리 시스템");

        final Activity a = IntellStatusActivity.this;
        ...
        new JSONTask().execute(ser+"/status/지능기전공학부");
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new JSONTask2().execute(ser+"/status/지능기전공학부");
