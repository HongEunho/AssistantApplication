...
public class SoftwareCurriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_software_curri);

        final Activity a = SoftwareCurriActivity.this;
        ...
        new JSONTask().execute(ser+"/curriculum/소프트웨어학과");
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new JSONTask2().execute(ser+"/curriculum/소프트웨어학과");
